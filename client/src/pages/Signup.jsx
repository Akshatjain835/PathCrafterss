...
const Signup = () => {
  ...
  const [form, setForm] = useState({ username: '', email: '', password: '', phone: '', location: '', role: 'Performer' })
          ...
          <Card>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
              <div className="hidden lg:block">
                ...
                <p className="text-sm text-gray-500">Create paths, collaborate with your team and manage performances.</p>
              </div>

              <div>
                <form onSubmit={onSubmit} className="grid grid-cols-1 gap-4">
                  <Input id="username" name="username" label="Username" value={form.username} onChange={onChange} />
                  <Input id="email" name="email" type="email" label="Email" value={form.email} onChange={onChange} description="We'll use this to send important updates." />
                  <Input id="password" name="password" type="password" label="Password" value={form.password} onChange={onChange} description="Use at least 8 characters." />
